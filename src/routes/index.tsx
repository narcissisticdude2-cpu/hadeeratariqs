      ...
      <section id="profile" className="grid min-h-screen lg:grid-cols-2">
        ...
        <div className="flex items-center bg-secondary px-5 py-24 sm:px-12 lg:px-[10%]">
          <div className="max-w-xl">
            ...
            <h2 className="text-balance font-sans text-[clamp(3.25rem,8vw,8rem)] font-normal leading-[0.92] tracking-normal">Ideas gain clarity when every dimension is considered.</h2>
